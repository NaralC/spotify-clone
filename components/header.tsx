    ...
    >
      <div className="flex items-center justify-between w-full mb-4">
        ...
        <div className="flex items-center justify-between gap-x-4">
          <>
            <div>
              <Button onClick={() => {}} className="font-medium bg-transparent text-neutral-300">Sign up</Button>
            </div>
            <div>
              <Button onClick={() => {}} className="px-6 py-2 font-medium bg-white">Log in</Button>
            </div>
          </>
        </div>
      </div>
